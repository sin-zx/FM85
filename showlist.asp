  ...
  <div class="row-fluid">
    ...
    <div class="main main_list">
      <ul class="list">
        ...
        <!-- 
        <li>
          <a href="" class="tit">20151108 六年一班巴拉巴拉巴拉</a>
          <div class="operateBtn">
            <button type="button" class="btn btn-success">在线收听</button>
    ...
    <h2 class='sub_title_white'>荔园观点 <img src="imgs/video.png" alt="video"></h2>
    <hr>
    <div class="main main_list">
      <ul class="list">
        <% 
