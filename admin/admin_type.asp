    ...
    <td width="50%" height="190" valign="top"> 
      <table width="90%" border="0" cellpadding="0" cellspacing="1" bgcolor="#000000">
        <tr align="center" bgcolor="#CCCCCC"> 
          <td width="19%" height="24">ID</td>
          <td width="44%">类别</td>
          <td width="44%" colspan="2">操作</td>
        </tr>
        <%
		Set rs=Server.CreateObject("ADODB.RecordSet") 
...
%>
    ...
    <td width="50%" align="center" valign="top"> 
      ...
      <table width="90%" border="0" cellpadding="0" cellspacing="1" bgcolor="#000000">
        <tr align="center" bgcolor="#CCCCCC"> 
          <td height="24" colspan="2"><font color="#0000FF">修改</font>新闻类别</td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
      ...
      <table width="90%" border="0" cellpadding="0" cellspacing="1" bgcolor="#000000">
        <tr align="center" bgcolor="#CCCCCC"> 
          <td height="24" colspan="2"><font color="#FF0000">添加</font>新闻类别</td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <form name="form1" method="post" action="admin_type.asp">
            <td width="50%" height="30" align="center"> 
